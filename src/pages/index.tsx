...
const services = [
  {
    title: "Web Design",
    description:
      "Sleek, responsive, music-inspired designs tailored to your vibe.",
    icon: "🌐",
  },
  {
  ...
  },
  {
    ...
    description:
      "From branding to full UI/UX kits — making digital look stunning.",
    icon: "🎨",
  },
];
  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content="DejnyO - Designing next-gen music-focused websites and apps with a punch of aesthetic graphics."
        />
      </Head>
      ...
      >
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center px-6 md:px-16">
          ...
          >
            <h3
              className={`text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r ${
                theme === "dark"
            ...
            >
              DejnyO is a digital agency blending{" "}
              <span className="font-semibold">creativity</span> with{" "}
              <span className="font-semibold">technology</span>. Our work is
              powered by design, driven by motion, and inspired by sound.
            </p>
      ...
      >
        <div className="max-w-7xl mx-auto md:px-8 flex flex-col items-center gap-12 relative">
          {/* Updated Title */}
          <h2
            className={`text-6xl font-extrabold text-center mb-4 text-transparent bg-clip-text bg-gradient-to-r ${
              theme === "dark"
                ? "from-cyan-400 via-blue-500 to-purple-500"
                : "from-purple-400 via-pink-400 to-rose-400"
            }`}
      ...
      <section
        id="offer"
        className={`py-24 px-6 w-full text-center ${
          theme === "dark" ? "bg-black" : "bg-white"
        }`}
      >
        <h2
          className={`text-5xl font-bold mb-16 lg:w-1/2 mx-auto text-transparent bg-clip-text bg-gradient-to-r ${
            theme === "dark"
              ? "from-cyan-400 via-blue-500 to-purple-500"
              : "from-purple-400 via-pink-400 to-rose-400"
          }`}
        ...
        <div className="grid md:grid-cols-3 gap-10 items-start">
          {/* Basic Plan */}
          <div
            className={`p-8 rounded-3xl shadow-2xl hover:scale-105 transition-all duration-500 flex flex-col justify-between ${
          ...
          >
            <div>
              ...
              >
                Starter package. Hosting, domain, security, SEO and lifetime
                updates for different events and occasions.
              </p>
            </div>
            <a
          ...
          <div
            className={`p-10 rounded-3xl shadow-2xl hover:scale-110 transition-all duration-500 flex flex-col justify-between transform md:-translate-y-6 border-2 ${
              theme === "dark"
          ...
          >
            <div>
              ...
              <p className="text-4xl font-extrabold text-white mb-1">$399</p>
              <p className="text-white/80 mb-6">
                One-time payment. Professional custom site with SEO, unique
                animations, and branding polish.
              </p>
            </div>
            <a
              href="mailto:contact@dejnyo.com"
          ...
          >
            <div>
              ...
              >
                Full custom solution for schools. User management, posts and
                calendar events and many other custom features.
              </p>
            </div>
            <a
              href="mailto:contact@dejnyo.com"
      ...
      <section
        id="team"
        className={`py-32 px-6 w-full text-center ${
          theme === "dark" ? "bg-black" : "bg-white"
        }`}
      >
        <h2
          className={`text-5xl font-bold mb-16 text-transparent lg:w-1/4 mx-auto bg-clip-text bg-gradient-to-r ${
            theme === "dark"
              ? "from-cyan-400 via-blue-500 to-purple-500"
      ...
      <section className="relative">
        <div className="h-screen">
          ...
          <div className=" text-center m-auto">
            <h2
              className={`text-5xl font-bold text-transparent lg:w-1/4 mx-auto bg-clip-text bg-gradient-to-r ${
                theme === "dark"
                  ? "from-cyan-400 via-blue-500 to-purple-500"
                  : "from-pink-400 via-pink-500 to-rose-400"
              }`}
          ...
          <div
            className={`absolute animate-pulse top-[30%] left-1/2 -translate-x-1/2 w-8 h-8 sm:w-[5vw] sm:h-[5vw] md:w-[3vw] md:h-[3vw] rotate-45 ${
      ...
      {/* Our Work Section */}
      <section
        className={`py-32  px-6 relative w-full text-center ${
          theme === "dark" ? "bg-black" : "bg-white"
        }`}
      >
        {/* Section Title */}
        <h2
          className={`text-5xl font-bold mb-16 lg:w-1/4 mx-auto text-transparent bg-clip-text bg-gradient-to-r 
    ${
      theme === "dark"
        ? "from-cyan-400 via-blue-500 to-purple-500"
        : "from-purple-400 via-pink-400 to-rose-400"
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {[
            ...
            },
            {
              title: "HearMe",
              description:
                "Website about voting best song everyday and showing people what kind of music is trendy each day",
          ...
          ${
            theme === "dark"
              ...
              >
                <h3
                  className={`text-2xl font-bold mb-3 group-hover:-translate-y-1 transition-transform duration-300
            ${
              theme === "dark"
      ...
      <section
        id="contact"
        className={`py-36 px-6 mx-auto text-center relative overflow-hidden ${
          theme === "dark" ? "bg-black" : "bg-white"
        }`}
      >
        {/* Background Gradient */}
        ...
        {/* Contact Title */}
        <h2
          className={`text-5xl md:text-6xl font-extrabold mb-8 py-2 text-transparent bg-clip-text bg-gradient-to-r ${
            theme === "dark"
        ...
        >
          Your ideas deserve more! Let&apos;s build something unforgettable —
          coded, crafted, and customized by DejnyO.
        </p>
